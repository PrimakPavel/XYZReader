...
import com.example.xyzreader.presentation.adapter.ArticleListAdapter;
import com.example.xyzreader.presentation.adapter.ArticleListClickListener;
import com.example.xyzreader.presentation.viewModels.MainViewModel;

import static com.example.xyzreader.presentation.screens.ArticleDetailFragment.ARG_ITEM_ID;
...
public class ArticleListFragment extends Fragment implements ArticleListClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onArticleItemClick(long articleId, ImageView imageView) {
        FragmentNavigator.Extras extras = new FragmentNavigator.Extras.Builder()
                .addSharedElement(imageView, getString(R.string.article_transition_name))
                .build();
        Bundle args = new Bundle();
        args.putLong(ARG_ITEM_ID, articleId);
        mNavController.navigate(R.id.action_articleListFragment_to_articleDetailFragment, args, null, extras);
    }
